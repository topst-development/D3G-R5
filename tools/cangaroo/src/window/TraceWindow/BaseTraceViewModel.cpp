...
QVariant BaseTraceViewModel::data_TextAlignmentRole(const QModelIndex &index, int role) const
{
    (void) role;
    switch (index.column()) {
        case column_timestamp: return (int) Qt::AlignRight + (int) Qt::AlignVCenter;
        case column_channel: return (int) Qt::AlignCenter + (int) Qt::AlignVCenter;
        case column_direction: return (int) Qt::AlignCenter + (int) Qt::AlignVCenter;
        case column_canid: return (int) Qt::AlignRight + (int) Qt::AlignVCenter;
        case column_sender: return (int) Qt::AlignLeft + (int) Qt::AlignVCenter;
        case column_name: return (int) Qt::AlignLeft + (int) Qt::AlignVCenter;
        case column_dlc: return (int) Qt::AlignCenter + (int) Qt::AlignVCenter;
        case column_data: return (int) Qt::AlignLeft + (int) Qt::AlignVCenter;
        case column_comment: return (int) Qt::AlignLeft + (int) Qt::AlignVCenter;
