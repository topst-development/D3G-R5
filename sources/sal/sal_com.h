...
typedef enum SALTaskPriority
{
    ...
    SAL_PRIO_VEHICLE_SIGNAL_DEMO        = 6,  /**< VSDR Receive Monitor Task            */
...
typedef SALRetCode_t                    (*SALQueueGet) (uint32 uiId, void * pData, uint32 * puiSizeCopied, sint32 iTimeout, SALBlockingOption_t  ulOptions);
